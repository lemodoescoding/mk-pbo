...
public class SalesItem
        ...
        */
        public boolean addComment(String author, String text, int rating)
        {
            ...
            if(ratingInvalid(rating)) { // reject invalid ratings
                System.out.println("DEBUG: Rating invalid");
                return false;
            }
            
            if(findCommentByAuthor(author) != null) {
                // reject multiple comments by same author
                System.out.println("DEBUG: Duplicate comment by the same author, invalid");
                return false;
            }
            
            comments.add(new Comment(author, text, rating));
            
            System.out.println("DEBUG: Comment were added");
            return true;
        }
        ...
        */
        ...
        {
            if(comments.isEmpty()) {
                System.out.println("DEBUG: No comment for this item");
            }
            ...
            while(it.hasNext()) {
                ...
                if(current.getVoteCount() > best.getVoteCount()) {
                    System.out.println("DEBUG: Found the best comment");
                    best = current;
                }
            }
